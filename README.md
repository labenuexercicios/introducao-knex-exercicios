# Exercício da tarde - Knex - Raw e QueryBuilder

ATENÇÃO! Não forke nem clone esse repositório. Ele serve apenas como enunciado!<br><br>

<strong>Continue trabalhando no seu repositório labecommerce-backend criado anteriormente. Evite trabalhar na main e crie branches para organizar cada nova implementação ou refatoração. A de hoje por exemplo, pode se chamar knex-raw-qbuilder.</strong>

### Comando para criar a branch e já entrar nela
```
git checkout -b knex-raw-qbuilder
```
<br>
